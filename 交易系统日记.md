...
- 在new_bar开始的时候，可能上一个止损单来不及取消，导致成交两个止损单的问题怎么解决？

# 2026-04-25:

- BinanceU更新了websocket的连接方式：https://developers.binance.com/docs/derivatives/usds-margined-futures/websocket-market-streams/Important-WebSocket-Change-Notice
- 要及时关注changeLog: https://developers.binance.com/docs/derivatives/change-log
